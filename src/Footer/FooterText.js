...
function FooterText()
{
    ...
    return(
         ...
         <p style={style}>When it comes to ethnic wear for women, the only brand that occurs to our mind is Biba. The first-ever brand came with the idea of ready-made ethnic wear dresses for women. The brand is in the retail business of ethnic dresses for a very long time with all India reach. Ethnic wear for women design by Biba does not only present impeccable designing but also shows the evolvement of Indian ethnic dresses in its collection. The brand follows the two seasons of fashion for its launch of ethnic dresses for women.
         </p>
